...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 ...
                 init_values=0, use_mean_pooling=False, masked_im_modeling=False, **kwargs):
        super().__init__()
    ...
    def forward(self, x, return_all_tokens=None, mask=None, attn_mask=None, num_frames=1, f2d=False, temporal_embed=None, pool=False):
        # mim
        ...
        if return_all_tokens and not pool:
            return x
        return x[:, 0]
