...
OUTPUT_DIR='outs/finetune/imgnet/mixed_2'
DATA_PATH='data_lists/co3d_train.txt'
DATA_ROOT='/oscar/data/tserre/data/ImageNetExp/exp/mixed'
...
python main_finetune_classification.py \
    ...
    --ckpt_path outs/finetune/imgnet/mixed_2/vit_small_patch16_224.augreg_in21k_ft_in1k/best_val.ckpt
