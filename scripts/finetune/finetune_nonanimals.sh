...
OUTPUT_DIR='outs/finetune/imgnet/nonanimal'
DATA_PATH='data_lists/co3d_train.txt'
DATA_ROOT='/oscar/data/tserre/data/ImageNetExp/exp/nonanimal'
...
NCCL_DEBUG=INFO OMP_NUM_THREADS=1  python -m torch.distributed.run \
    ...
    --imgnet_clickmaps_path ./assets/imagenet_val_nonanimals_0.1_processed.npz \
    --imgnet_clickmaps_human_path ./assets/human_ceiling_split_half_imagenet_val_nonanimals_0.1.npz \
    --ckpt_path outs/finetune/imgnet/nonanimal/vit_small_patch16_224.augreg_in21k_ft_in1k/best_val.ckpt
