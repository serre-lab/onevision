...
OUTPUT_DIR='outs/finetune/imgnet/mixed_50_2'
DATA_PATH='data_lists/co3d_train.txt'
DATA_ROOT='/oscar/data/tserre/data/ImageNetExp/exp/mixed_50'
...
python main_finetune_classification.py \
    ...
    --ckpt_path outs/finetune/imgnet/mixed_50_2/vit_small_patch16_224.augreg_in21k_ft_in1k/best_val.ckpt
