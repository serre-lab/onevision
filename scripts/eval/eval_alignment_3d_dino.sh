...
OUTPUT_DIR='outs/3d_dino_vit_small_patch16_pretrained_0206'
...
python  -m tools.eval_alignment \
        ...
        --mask_ratio 0.75 \
        --model dino_3d_vit_small_patch16 \
        --batch_size 64 \
        --lr 0.015 \
        --no-binocular \
        --num_frames 8 \
        ...
        --ckpt_path outs/3d_dino_vit_small_patch16_pretrained_0206/checkpoint-0.pth